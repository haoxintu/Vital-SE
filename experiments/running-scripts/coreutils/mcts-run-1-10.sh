...
# for bc in {base64,basename,cat}
for bc in {base64,basename,cat,chcon,chgrp,chmod,chown,chroot,comm}
# for bc in {basename,cat,chcon,chgrp,chmod,chown,chroot,comm}
# for bc in {chcon,chgrp,chmod,chown,chroot,comm}
do
