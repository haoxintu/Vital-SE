...
# for bc in {false,fmt,fold,head,hostid,hostname,id,ginstall,join,kill}
for bc in {fmt,fold,head,hostid,id,ginstall,join,factor,nice}
# for bc in {fmt,head,hostid,id,ginstall,join,kill}
do
