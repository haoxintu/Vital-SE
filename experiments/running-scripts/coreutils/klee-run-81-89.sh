...
--search=$search --package-name=dd \
--output-dir="klee-out-$time-min-$search-dd" \
--write-no-tests \
...
--watchdog --max-memory-inhibit=false --max-static-fork-pct=1 \
--max-static-solve-pct=1 --max-static-cpfork-pct=1 --switch-type=internal \
--search=$search --package-name=dircolors \
...
--watchdog --max-memory-inhibit=false --max-static-fork-pct=1 \
--max-static-solve-pct=1 --max-static-cpfork-pct=1 --switch-type=internal \
--search=$search --package-name=echo \
...
--watchdog --max-memory-inhibit=false --max-static-fork-pct=1 \
--max-static-solve-pct=1 --max-static-cpfork-pct=1 --switch-type=internal \
--search=$search --package-name=expr \
...
--watchdog --max-memory-inhibit=false --max-static-fork-pct=1 \
--max-static-solve-pct=1 --max-static-cpfork-pct=1 --switch-type=internal \
--search=$search --package-name=mknod \
...
--watchdog --max-memory-inhibit=false --max-static-fork-pct=1 \
--max-static-solve-pct=1 --max-static-cpfork-pct=1 --switch-type=internal \
--search=$search --package-name=pathchk \
...
--watchdog --max-memory-inhibit=false --max-static-fork-pct=1 \
--max-static-solve-pct=1 --max-static-cpfork-pct=1 --switch-type=internal \
--search=$search  --package-name=printf \
...
#for bc in {tty,uname,unexpand,uniq,unlink,uptime,users,wc,whoami,who}
#do
#klee --simplify-sym-indices --write-cvcs --write-cov --output-module \
#--max-memory=1000 --disable-inlining --optimize=false --use-forked-solver \
#--use-cex-cache --libc=uclibc --posix-runtime \
...
#--watchdog --max-memory-inhibit=false --max-static-fork-pct=1 \
#--max-static-solve-pct=1 --max-static-cpfork-pct=1 --switch-type=internal \
#--search=$search --package-name=yes \
#--output-dir="klee-out-$time-min-$search-yes" \
#--write-no-tests \
#./yes.bc -sym-args 0 1 10 --sym-args 0 2 2 --sym-files 1 8 --sym-stdin 8 --sym-stdout
#done
