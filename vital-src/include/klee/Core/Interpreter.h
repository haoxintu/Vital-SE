...
public:
  ...
  virtual void incPathsCompletedSimulation() = 0; // THX
  virtual void incPathsExploredSimulation(std::uint32_t num = 1) = 0; // THX
  virtual unsigned getNumStatesSimulated() = 0; // THX
  virtual void incNumSimulatedStates() = 0; // THX
  virtual unsigned getNumInitialStatesSimulated() = 0; // THX
  virtual void incNumInitialSimulatedStates() = 0; // THX
...
public:
  ...
  virtual std::map<std::string, unsigned long long> getUnsafeMemoryOperationRecords() = 0; // THX
};
